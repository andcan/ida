...
Il compose contiene anche jupyter, accessibile alla porta 8888. Per ottenere il token di accesso bisogna guardare il log del container con

```
docker logs devcontainer_jupyter
```

Aggiustare il comando usando il nome corretto (per vedere la lista container `docker ps`)
