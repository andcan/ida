...
from gremlin_python.process.traversal import Binding as Binding, Bytecode as Bytecode, Direction as Direction, P as P, T as T, TextP as TextP, Traversal as Traversal, TraversalStrategy as TraversalStrategy, Traverser as Traverser
from gremlin_python.statics import ByteBufferType as ByteBufferType, DictType as DictType, FloatType as FloatType, FunctionType as FunctionType, IntType as IntType, ListType as ListType, LongType as LongType, SetType as SetType, SingleByte as SingleByte, SingleChar as SingleChar, TypeType as TypeType
...
class ListIO(_GraphSONTypeIO):
    ...
    graphson_type: str = ...
    @classmethod
    def dictify(cls, l: Any, writer: Any): ...
    @classmethod
    def objectify(cls, l: Any, reader: Any): ...

class SetIO(_GraphSONTypeIO):
    python_type: Any = ...
    graphson_type: str = ...
    @classmethod
    def dictify(cls, s: Any, writer: Any): ...
    @classmethod
    def objectify(cls, s: Any, reader: Any): ...

class MapType(_GraphSONTypeIO):
    python_type: Any = ...
    graphson_type: str = ...
    @classmethod
    def dictify(cls, d: Any, writer: Any): ...
    @classmethod
    def objectify(cls, l: Any, reader: Any): ...
